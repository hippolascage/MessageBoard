...
(function () {
    ...
    var topicsController = ["$http", "dataService", function ($http, dataService) {
        var vm = this;
        vm.data = dataService;
        vm.isBusy = false;
    ...
    var singleTopicController = ["$window", "dataService", "$routeParams", function ($window, dataService, $routeParams) {
        var vm = this;
        vm.topic = null;
        vm.newReply = {};
    ...
    var newTopicController = ["$http", "$window", "dataService", function ($http, $window, dataService) {
        var vm = this;
        vm.newTopic = {};
